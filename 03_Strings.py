...
my_string5 = "\\tEste es un String \\n escapado" #La doble barra ignora al 'n' y al 't'
print(my_string5)

# Formateo
name, surname, age = "Luis", "Pareja", 19

print("Mi nombre es {} {} y mi edad es {}".format(name, surname, age)) # {} es para llamar a las variables dentro de la cadena
print("Mi nombre es %s %s y mi edad es %d" %(name, surname, age)) # %s es para strings y %d es para enteros
print("Mi nombre es " + name + " " + surname + " y mi edad es " + str(age)) # Concatenación
print(f"Mi nombre es {name} {surname} y mi edad es {age}") # f llama a las variables directamente dentro de la cadena
...
# Division
language_slice = language[1:3] # toma un substring desde el indice 1 hasta el 3 (sin incluirlo)
print(language_slice)

language_slice = language[1:] # toma un substring desde el indice 1 hasta el final del string
print(language_slice)
...
print("Py" == "py") # Son diferentes strings
